            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-12">
                    <div class="order-details">
                            ...
                            <div class="content">
                                <ul>
                                    ...
                                    <li class="shipping">
                                        ...
                                        @if(Helper::totalCartPrice()<300) <span>£50</span>
                                            @else
                                            <span>Free</span>
                                            @endif
                                    </li>
                                    ...
                                    <li class="last" id="order_total_price">
                                        Total
                                        @if(Helper::totalCartPrice()<300)
                                            £{{number_format(Helper::totalCartPrice() + 30),2)}}</span>
                                            @else
                                            <span>£{{number_format(Helper::totalCartPrice() + (Helper::totalCartPrice() * 0.2),2)}}</span>
                                            @endif
                                    </li>
                                    @endif
                                </ul>
                        ...
                        <div class="form-group">
                            <input type="text" class="input field w-100 pt-0" placeholder="Card holder name" name="name"
                                id="name" autocomplete="off" required>
                        </div>

                        <div class="form-group">
                            <div id="card-element" class="field" class="form-control"
                                style='border:1px solid #ccc;padding:10px'></div>
                            <div class="text-danger mt-3 mb-0 pb-0" id="card-errors" role="alert"></div>
                        </div>


                        <!--===============END STRIPE CHECKOUT FIELDS===================-->

                        <!-- Button Widget -->
                        <div class="single-widget get-button">
                            <div class="content">
                                <div class="button">
                                    <button type="submit" class="btn" id="purchase-btn">proceed to checkout</button>
                                </div>
                            </div>
                        </div>
                        <!--/ End Button Widget -->
