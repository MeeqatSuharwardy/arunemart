...
@section('title','Floormasters || PRODUCT PAGE')
                                    ...
                                    <div class="single-shorter">
                                        ...
                                        <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                            ...
                                            <option value="title" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='title' ) selected @endif>
                                                Name
                                            </option>
                                            <option value="price" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='price' ) selected @endif>
                                                Price
                                            </option>
                                            <option value="category" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='category' ) selected @endif>
                                                Category
                                            </option>
                                            <option value="brand" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='brand' ) selected @endif>
                                                Brand
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="button-head">
                                        ...
                                        <div class="product-action-2">
                                            <a data-toggle="modal" data-target="#{{$product->id}}" title="Add to cart"
                                                href="#">Add to cart</a>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <form action="{{route('single-add-to-cart')}}" method="POST">
                                @csrf
                                @php $widths = getWidth($product->width_ids) @endphp
                                @if($widths)
                                <div class="size mb-3" style="margin-bottom: 10px;">
                                    <h4>Width</h4>
