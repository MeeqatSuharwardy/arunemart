						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
                                ...
                                <ul>
                                    ...
                                    @endphp
                                    @if(session()->has('coupon'))
                                    <li class="last" id="order_total_price">VAT
                                        <span>£{{number_format($total_amount * 0.2),2}}</span>
                                    </li>
                                    @else
                                    <li class="last" id="order_total_price">VAT (20%)
                                        <span>£{{($total_amount * 0.2),2}}</span>
                                    </li>
                                    @endif
                                    <li class="last" id="order_total_price">Total Payable
                                        <span>£{{(($total_amount * 0.2) + $total_amount),2}}</span>
                                    </li>
                                </ul>
                                <div class="button5">
