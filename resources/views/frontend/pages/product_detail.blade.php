...
@endsection
@section('title','Floormasters || PRODUCT DETAIL')
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="product-des">
                            ...
                            <div class="short">
                                ...
                                @endphp
                                <p class="price"><span
                                        class="discount">£{{number_format($after_discount,2)}}</span><s>£{{number_format($product_detail->price,2)}}
                                    </s><span> per
                                        &#13217;</span>
                                </p>
                                ...
                                <form action="{{route('single-add-to-cart')}}" method="POST">
                                    ...
                                    <div class="quantity mt-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="quant[1]" class="input-number quantity_length"
                            ...
                            <div class="size">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <select class="js-states browser-default select2" name="product_detail_id"
                                            required id="product_detail_id">
                                            <option value="option_select" disabled selected>Width</option>
                                            @foreach(getWidth($product_detail->width_ids) as $size)
...
$(document).on('change', '.width_id', function() {
    let width = $('option:selected', this).attr('data-width');
    let quantity = $('.quantity_length').val();

    calculateTotal(quantity, width ?? 1)
})
$(document).on('change', '.quantity_length', function() {
    let quantity = $(this).val();
    let width = $('option:selected', '.width_id').attr('data-width');

    calculateTotal(quantity, width ?? 1)
})

function calculateTotal(len, wid) {
    let subtotal = $('.subtotal').text();
    let total = subtotal * len * wid;
    $('.total_price_lw').text(total);
}
</script>
