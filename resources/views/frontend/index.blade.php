...
@section('title','Floormasters || HOME PAGE')
...
<section id="Gslider" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item {{(($key==0)? 'active' : '')}}">
            ...
            <h1 style="float: right; padding-left: 40%;">{{$banner->title}}</h1>
            <p class="clearfix">{!! html_entity_decode($banner->description) !!}</p>
...
<div>
    <h2 class="blink">book your product </h2>
</div>
<style>
blink {
    font-size: 5em;
