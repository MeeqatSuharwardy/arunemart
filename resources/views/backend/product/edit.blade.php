...
<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="{{route('product.update',$product->id)}}">
            ...
            <div class="form-group">
                <label for="price" class="col-form-label">Price(GBP) <span class="text-danger">*</span></label>
            ...
            <div class="form-group">
                <label for="width_id">Widths</label>
                {{-- {{$widths}} --}}

                <select  name="width_ids[]" class="form-control max-length"  multiple id="select2-limited">
                    @foreach($widths as $width)
                        @php($selected = is_array($product->width_ids) && in_array($width->id,$product->width_ids) ? 'selected' : '')
                    <option {{$selected}} value="{{$width->id}}">{{$width->title}}</option>
                    @endforeach
                </select>
            </div>
